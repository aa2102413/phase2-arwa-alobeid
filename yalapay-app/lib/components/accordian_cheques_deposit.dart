...
class _AccordianChequesDepositState
  ...
  Widget build(BuildContext context) {
    ...
    for (var cheque in widget.chequeDeposit.chequeNos) {
      Cheque c = readChequeNotifier.getChequeById(cheque) as Cheque;
      if (selectedCheques.contains(c)) {
        continue;
      } else {
        selectedCheques.add(c);
      }
      if (c.status == 'Cashed') {
        amountPaid += c.amount;
      } else {
          ...
          children: [
            ...
            if (isIconUp)
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Details:   (ID: ${widget.chequeDeposit.id})',
                      style: const TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        SizedBox(
                          child: Row(
                            children:
                                widget.chequeDeposit.chequeNos.map((chequeNo) {
                              return Container(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: 8.0, vertical: 4.0),
                                                      ...
                                                      children: [
                                                        ...
                                                        Row(
                                                          children: [
                                                            ...
                                                            Text(
                                                                '${SimpleDate(cheque.receivedDate.year, cheque.receivedDate.month, cheque.receivedDate.day)}',
                                                                style: TextStyle(
                                                                    fontSize:
                                                                        12)),
                                                          ],
