...
class _AddInvoiceScreenState extends ConsumerState<AddInvoiceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final fbInvoiceNotifier = ref.read(invoiceNotifierProvider.notifier);
              ...
              Container(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    ...
                    customerName = readCustomerNotifier
                    ...
                    if (widget.isAdd) {
                      ...
                      fbInvoiceNotifier.addInvoice(Invoice(
                        id,
                        customerID!,
                        customerName!,
                        amount!,
